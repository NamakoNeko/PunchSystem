...
public class AdminManageUI extends JFrame
{
	...
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				try
				{
					AdminManageUI frame = new AdminManageUI();
	...
	public AdminManageUI()
	{
		...
		AdminManageUI.addMenuListener(comboBoxStartYear, comboBoxStartMonth, comboBoxStartDay, comboBoxStartYear);
		AdminManageUI.addMenuListener(comboBoxStartYear, comboBoxStartMonth, comboBoxStartDay, comboBoxStartMonth);
		...
		AdminManageUI.addMenuListener(comboBoxEndYear, comboBoxEndMonth, comboBoxEndDay, comboBoxEndYear);
		AdminManageUI.addMenuListener(comboBoxEndYear, comboBoxEndMonth, comboBoxEndDay, comboBoxEndMonth);
		...
		btnNewButton.setBounds(70, 218, 84, 22);
		...
		btnNewButton_1.setBounds(175, 218, 84, 22);
		contentPane.add(btnNewButton_1);
		
		JButton btnNewButton_1_1 = new JButton("員工管理");
		btnNewButton_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				AdminManageEmployeeUI adminManageEmployeeUI = new AdminManageEmployeeUI();
				adminManageEmployeeUI.setVisible(true);
				dispose();
			}
		});
		btnNewButton_1_1.setBounds(284, 218, 84, 22);
